...
interface Component {
    ...
    component_name: string; // Unique component name from Frappe
    criteria_table?: any[]; // Table of criteria from Frappe
    questions?: any[]; // Table of questions from Frappe
    or?: string; // Link to another component from Frappe
    ...
    const [components, setComponents] = useState<Component[]>([
        {
            ...
            component_name: "Animal Induction (Calved Cow)",

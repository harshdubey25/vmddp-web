import { Milk, HeartPulse, Pill, Sparkles, Sprout, Scissors, Package, Stethoscope, GraduationCap } from "lucide-react";
...
export const componentData: ComponentDetail[] = [
  {
    ...
    shortDescription: "Financial assistance for purchasing high-yielding calved indigenous or crossbred dairy cows",
    fullDescription: "Under the Vidarbha and Marathwada Dairy Development Project, 13,400 high milk-yielding cows and buffaloes will be distributed over three years across 19 districts. Each beneficiary receives one cow or buffalo with minimum 8-10 litres daily milk production capacity.",
    ...
    subsidyInfo: {
      amount: "₹50,000",
      percentage: "50%",
      details: "50% subsidy of cost or ₹50,000 (whichever is less). Average cost per animal: ₹1,00,000 including digital tagging, transportation, and insurance."
    },
    termsAndConditions: [
  ...
  },
  {
    ...
    shortDescription: "High Genetic Merit pregnant heifer support through IVF embryo transfer for enhanced dairy productivity",
    fullDescription: "Embryo transfer using In-Vitro Fertilization (IVF) technology produces high-genetic-quality offspring, increasing future high-yielding cows and buffaloes. Pregnant heifers developed using IVF embryos from reputed institutions like MLDB, BAIF, Godrej Agrovet, and NDS.",
    ...
    subsidyInfo: {
      amount: "₹1,08,750",
      percentage: "75%",
      details: "75% subsidy or ₹1,08,750 (whichever is less). Average cost per heifer: ₹1,45,000 including IVF process, maintenance, and pregnancy."
    },
    termsAndConditions: [
  ...
  },
  {
    ...
    subsidyInfo: {
      amount: "25% subsidy",
      percentage: "25%",
      details: "Cost: ₹9,600 per animal (₹32 per kg × 300 kg for 60 days). 25% subsidy provided via DBT after purchase proof submission."
    },
    requiredDocuments: [
      "Aadhar Card",
  ...
  },
  {
    ...
    subsidyInfo: {
      amount: "₹6,000",
      percentage: "100%",
      details: "100% subsidy up to ₹6,000 per beneficiary for quality fodder seeds and cuttings."
    },
    requiredDocuments: [
      "Aadhar Card",
  ...
  },
  {
    ...
    subsidyInfo: {
      amount: "₹15,000",
      percentage: "50%",
      details: "50% subsidy or ₹15,000 (whichever is less). Estimated cost per unit: ₹30,000. Subsidy via DBT after GST invoice submission."
    },
    requiredDocuments: [
      "Aadhar Card",
  ...
  },
  {
    ...
    shortDescription: "Preserved green fodder supply during scarcity to maintain continuous milk production",
    fullDescription: "During fodder shortage periods, silage (preserved green fodder) helps maintain continuous milk production. Project provides 5 kg silage per day per animal for one month with subsidy support.",
    ...
    subsidyInfo: {
      ...
      details: "₹3 per kg subsidy on silage. Supply of 5 kg per day per animal for one month. DBT transfer after purchase proof."
    },
    requiredDocuments: [
      "Aadhar Card",
      "Animal ownership proof",
  ...
  },
  {
    ...
    shortDescription: "Comprehensive veterinary treatment program to restore productivity in infertile animals",
    fullDescription: "Based on 20th Livestock Census (2019), 30% of 35.62 lakh breedable cows and buffaloes in 19 districts face temporary infertility. Treatment provided through hormonal therapy and traditional methods at veterinary dispensaries.",
    ...
    subsidyInfo: {
      ...
      details: "Service fees as per government norms. Treatment through veterinary dispensaries. Detailed records of treated animals and successful conceptions maintained."
    },
    requiredDocuments: [
      "Animal ownership proof",
  ...
  },
  {
    ...
    shortDescription: "Two-day training programs on modern dairy management practices and best techniques",
    fullDescription: "Comprehensive capacity building programs for 36,000 farmers on modern dairy management, animal health, and best practices through recognized institutions like State Animal Husbandry Department, Veterinary Universities, and Krishi Vigyan Kendras (KVKs).",
    ...
    subsidyInfo: {
      ...
      details: "Completely free training programs organized through recognized institutions. No fees charged from participating farmers."
    },
    requiredDocuments: [
      "Aadhar Card",
